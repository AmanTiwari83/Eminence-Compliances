...
export function Footer() {
  ...
  const x2 = Number(
    (200 + Math.cos(angle) * 700).toFixed(2)
  );

  const y2 = Number(
    (300 + Math.sin(angle) * 700).toFixed(2)
  );
  ...
  >
    ...
    />
          ...
          <div className="lg:col-span-2 space-y-4">
            <h4
              className="family-regular text-[11px] tracking-[0.2em] uppercase"
              style={{ color: "#bc8737" }}
            >
              Regulatory Services
            </h4>
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <p
              className="family-regular text-xs leading-relaxed"
              style={{ color: "rgb(233 229 222 / 90%)" }}
            >
      ...
      <div style={{ borderTop: "1px solid rgba(188,135,55,0.15)" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p
              className="family-regular text-xs text-center sm:text-left"
              style={{ color: "rgb(233 229 222 / 90%)" }}
            >
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span
                className="family-regular text-xs"
                style={{ color: "rgb(233 229 222 / 90%)" }}
              >

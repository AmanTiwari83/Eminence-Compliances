          ...
          <div className="lg:col-span-7 order-1 lg:order-2">
            <div className="flex flex-col space-y-5 lg:space-y-6">
              ...
              <motion.div variants={itemVariants} className="pt-4 flex flex-col sm:flex-row items-start sm:items-center gap-6">
                <Link href="/about" className="group relative flex items-center gap-3 px-7 py-3.5 bg-primary-800 text-white rounded-lg family-bold text-xs tracking-widest overflow-hidden transition-all active:scale-95 shadow-md">
